class HomeController < ApplicationController
	...
	def index
		@post = Post.new
		@friend = @user.all_following.unshift(@user)
		@activities = PublicActivity::Activity.all.where(owner_id: @friends).order(created_at: :desc).paginate(page: params[:page], per_page: 10)
	end
